...
TEST_CASE("x86_64::ManagedPhysicalMemoryMap::map_page -- basic example", "[x86_64]")
{
    ...
    x86_64::ManagedPhysicalMemoryMap phys_map{context.mmu_, context.page_frame_allocator_};
...
TEST_CASE("x86_64::ManagedPhysicalMemoryMap::set_readonly -- zero size region", "[x86_64]")
{
...
TEST_CASE("x86_64::ManagedPhysicalMemoryMap::set_readonly -- one-byte region region", "[x86_64]")
{
...
TEST_CASE("x86_64::ManagedPhysicalMemoryMap::set_readonly -- one-page region region", "[x86_64]")
{
