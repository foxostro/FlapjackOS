...
TEST_CASE("x86_64::UnmanagedPhysicalMemoryMap::map_page -- basic example", "[x86_64]")
{
    ...
    x86_64::UnmanagedPhysicalMemoryMap phys_map{context.mmu_};
...
TEST_CASE("x86_64::UnmanagedPhysicalMemoryMap::set_readonly -- zero size region", "[x86_64]")
{
...
TEST_CASE("x86_64::UnmanagedPhysicalMemoryMap::set_readonly -- one-byte region region", "[x86_64]")
{
...
TEST_CASE("x86_64::UnmanagedPhysicalMemoryMap::set_readonly -- one-page region region", "[x86_64]")
{
